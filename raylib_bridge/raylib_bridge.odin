...
is_key_pressed : proc "c" (key : _c.int) -> bool;
is_key_down : proc "c" (key : _c.int) -> bool;
is_key_released : proc "c" (key : _c.int) -> bool;
is_key_up : proc "c" (key : _c.int) -> bool;
get_key_pressed : proc "c" () -> _c.int;
set_exit_key : proc "c" (key : _c.int);
